...
<body>
    <div class="heading">
        <h2>Booking Water Tank Service</h2>
    </div>
    <div class="container">
        <form class="row g-3" action="../services/services_request.php" method="post">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" name="phone_number"
                    placeholder="+ 60 ********" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback"
                    required>
                <div class="invalid-feedback" id="validationServerUsernameFeedback">
                    Please choose a contact nunber.
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <label class="form-label" for="validationServer04">Booking Water Tank (Size)</label>
                <select type="text" class="form-select is-invalid" name="booking" id="validationServer04"
                    aria-describedby="validationServer04Feedback" required>
                    <option selected disabled value="500">500 liters</option>
                    <option value="1000">1000 liters</option>
                    <option value="1500">1500 liters</option>
                    <option value="2000">2000 liters</option>
                    <option value="2500">2500 liters</option>
                    <option value="3000">3000 liters</option>
                    <option value="3500">3500 liters</option>
                    <option value="4000">4000 liters</option>
                    <option value="4500">4500 liters</option>
